...
class TestOnelap:
    ...
    def test_report(self, login_onelap):
        ...
        # 初次登录时使用
        # find_element(driver, 'id', "com.android.packageinstaller:id/permission_allow_button").click()
        ...
        # find_element(driver, 'id', 'com.onelap.bls.dear:id/tv_confirm_common_dialog').click()
